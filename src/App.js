...
const data = [
    {
		id: "1",
		img: "https://ipfs.io/ipfs/QmR9zmhJPnBoF4fsswehipNabqhUJSgmZJSsNXRhgRCm69",
...
const apikey = "789U75FG4B9HB1A5YI63NPXNIQUYN7S45M";
const endpoint = "https://api-rinkeby.etherscan.io/api"

const ADDRESS = "0x2df2a5d0f8352c1fa4495433d294091ec9b69a98";
...
<div className='row'>
  <form class = "col-lg-5" style = {{borderRadius: "25px" , boxShadow: "1px 1px 10px #000000"}}>
     <h4>MINT PORTAL </h4>
     <h5>Please connect wallet</h5>
     <Button onClick={connectwallet} style ={{marginButton: "5px"}}> Connect wallet</Button>
     <div class = "card " id = "wallet-address" style ={{marginTop: "5px"}}>
        <label for = "floatinginput">Wallet address</label>
		</div>
		<div class = "card "  style ={{marginTop: "5px"}}>
        <input type="number" name ="amount" defaultValue = "1" min ="1" max = "5" ></input>
        <label > PLEase enter the amount of nft to mint</label>
